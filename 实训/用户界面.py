...
class Ui_MainWindow(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "用户管理系统"))
        self.pushButton1.setText(_translate("MainWindow", "用户管理"))
        self.pushButton2.setText(_translate("MainWindow", "项目管理"))
        self.pushButton3.setText(_translate("MainWindow", "账号管理"))
        self.pushButton8.setText(_translate("MainWindow", "查询"))
        self.comboBox.setItemText(0, _translate("MainWindow", "按id查询"))
        self.comboBox.setItemText(1, _translate("MainWindow", "按账号查询"))
        self.comboBox.setItemText(2, _translate("MainWindow", "按银行查询"))
        self.comboBox.setItemText(3, _translate("MainWindow", "按手机号查询"))
        self.comboBox.setItemText(4, _translate("MainWindow", "按企业编号查询"))
        ...
        self.action1.setText(_translate("MainWindow", "查看用户信息"))
    ...
    def add_corporate(self):
        # self.hide()
        # 登录界面打开
        self.addac = 企业信息增加.Ui_MainWindow()
        self.addac.show()

    def del_corporate(self):
        # self.hide()
        # 登录界面打开
        self.delco = 企业信息删除.Ui_MainWindow()
        self.delco.show()

    def co_show_andupdate(self):
        # self.hide()
        # 登录界面打开
        self.delco = 企业账号修改.Ui_MainWindow()
        self.delco.show()

    def detail_mg_ac(self):
        self.hide()  # 主界面的隐藏
        self.gtmc =管理员主页面.Ui_MainWindow()
        #注册界面打开
        self.gtmc.show()
    ...
    def find_info(self):#书籍查询 '''查询中的翻页没做'''
        ...
        if text == "":
            ...
            if choice == '按id查询':
                sql = "select * from t_account where a_id like '%" + text + "%'"
                self.search_libs_info(sql)
            elif choice == '按账号查询':
                sql = "select * from t_account where ac_number='%s'" % text
                self.search_libs_info(sql)
            elif choice == '按银行查询':
                sql = "select * from t_account where bank_name like '%" + text + "%'"
                self.search_libs_info(sql)
            elif choice == '按手机号查询':
                sql = "select * from t_account where ac_phone like '%" + text + "%'"
                self.search_libs_info(sql)
            elif choice == '按企业编号查询':
