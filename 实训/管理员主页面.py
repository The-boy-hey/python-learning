...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        # 书籍操作事件绑定
        self.pushButton1.clicked.connect(self.show_lib)  # 添加书籍
        self.pushButton2.clicked.connect(self.del_lib)  # 淘汰书籍
        self.pushButton3.clicked.connect(self.user_manage)  # 用户管理
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action1.setText(_translate("MainWindow", "企业信息"))
    ...
    def find_info(self):#书籍查询 '''查询中的翻页没做'''
        ...
        if text == "":
            ...
            if choice == '按用户账号查询':
                sql = "select * from t_account where ac_number like '%" + text + "%'"
